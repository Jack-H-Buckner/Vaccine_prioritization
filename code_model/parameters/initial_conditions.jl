"""
This module sets the initial conditions for the main simulations
There are aproximately the stable distribution of cases predicted
by the model linearized around the origin
"""
