"""
This module runs the policies for each alternative scenario against
each scenario creating a matrix of values. the values from this analysis
represetn the value of knowing the true scenario with certainty.
"""
...
v(t) = 0.1/30
# tests
policy_path_main_text = "../data_outputs/main_text_full_policies.csv"
...
# #
# tests
policy_path_weak_NPI = "../data_outputs/weak_NPI_policies.csv"
...
# #
# tests
policy_path_strong_NPI = "../data_outputs/strong_NPI_policies.csv"
...
# #
# tests
policy_path_high_init_infections = "../data_outputs/high_initial_infections_policies.csv"
params_high_init_infections =  (
...
# #
# tests
policy_path_high_sucept_children = "../data_outputs/high_sucept_children_policies.csv"
...
#
# tests
policy_path_low_effectiveness_60 = "../data_outputs/Low_effectiveness_60_policies.csv"
...
# #
# tests
policy_path_Low_effectiveness = "../data_outputs/Low_effectiveness_policies.csv"
...
# #
# tests
policy_path_schools_open = "../data_outputs/schools_open_policies.csv"
...
#tests
v2(t) = 0.1/60
policy_path_low_supply = "../data_outputs/low_supply_policies.csv"
...
# tests
policy_path_high_contacts_social = "../data_outputs/high_contacts_social_policies.csv"
...
# tests
print("ramp:  ")
policy_path_ramp_up = "../data_outputs/Ramp_up_policies.csv"
params_ramp_up =  (R0.solve_R_40(parameters.R_0, parameters.suceptability_work1).zero[1],
        0.65,
        distancing_senarios.constant_beta03_alpha04_40,
        initial_conditions.calc_IC(0.90,0.005,0.08,
            parameters.bins_04 ,
...
# print tese to check against value form optimizaiton
# to insure the params are correct
print(get_outcomes(policy_path_ramp_up, params_ramp_up))
print("\n")
...
CSV.write("../data_outputs/comparison_data.csv", make_comparisions(Policy_names, params, paths))
end # module
